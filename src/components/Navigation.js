...
const NavigationComponent = ({isNavOpen, dispatch}) => {
  return (
    <div className="header">
      ...
      <div className="drawerButton" onClick={(e) => dispatch(setNavOpen(!isNavOpen))} >
        NAVIGATION
      </div>
      <Drawer right={true} className="navDrawer" fadeOut={true} handleWidth={0}
             open={isNavOpen} onChange={open => dispatch(setNavOpen(open))}>
